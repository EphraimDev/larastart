  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-10 mt-4">
        <h3 class="not-found-text blue">The Page You Are Trying To Access Is Not Available</h3>
        <svg
        ...
        >
          ...
          <title>warning</title>
          <ellipse cx="530.99" cy="416.32" rx="466.48" ry="416.32" fill="#6c63ff" opacity="0.1"></ellipse>
          <ellipse cx="172" cy="629.28" rx="172" ry="26.66" fill="#6c63ff" opacity="0.1"></ellipse>
          <ellipse cx="254.67" cy="769.13" rx="66.9" ry="13.82" fill="#6c63ff" opacity="0.1"></ellipse>
          <ellipse cx="711.8" cy="715.96" rx="66.9" ry="13.82" fill="#6c63ff" opacity="0.1"></ellipse>
          <ellipse cx="484.79" cy="699.75" rx="108.79" ry="18.43" fill="#6c63ff" opacity="0.1"></ellipse>
          <ellipse cx="805.34" cy="608.52" rx="226.91" ry="35.54" fill="#6c63ff" opacity="0.1"></ellipse>
          <path
